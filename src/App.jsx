...
const PROJECTS = {
  all: [
    ...
    { id: 21, title: "Mountain Hardwear — Seek Wilder Paths", role: "Cinematographer / Editor", category: "Brand", aspect: "16/9", thumb: "/images/thumb_7.jpg", vimeo: "858091000", stills: ["/images/stills/mtn_hardwear_02.jpg", "/images/stills/mtn_hardwear_03.jpg", "/images/stills/mtn_hardwear_04.jpg", "/images/stills/mtn_hardwear_01.jpg"] },
...
function HomeBlurb({ animate, onAnimated, onNavigate }) {
  ...
  useEffect(() => {
    ...
    const t = setTimeout(() => setSplashPhase("blurb"), 200);
    return () => clearTimeout(t);
  }, [splashPhase]);
  ...
  const showBlurb = splashPhase === "blurb" || splashPhase === "done" || !animate;
  const getWordStyle = (i, isBold, isName, link) => {
    ...
    const shouldSplashAnimate = showBlurb && animate && splashPhase === "blurb";
    if (shouldSplashAnimate) return { ...base, opacity: 0, animation: `wordFade 1s ease-in-out ${delays[i]}s forwards` };
    ...
    if (!showBlurb) return { ...base, opacity: 0 };
  ...
  return (
    <div className="home-blurb-parent" style={{ position: "relative", minHeight: "100vh", overflow: "hidden" }}>
      ...
      <div className="home-blurb-wrap" style={{ paddingTop: "24vh", minWidth: 720, width: 720, margin: "0 auto", position: "relative", zIndex: 2, opacity: showBlurb ? 1 : 0 }}>
