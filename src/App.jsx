  ...
  return (
    <div>
      ...
      <div className="project-detail-padded" style={{ maxWidth: 720, margin: "0 auto" }}>
        <div onClick={onBack} className="hover-spread" style={{ fontSize: 10, fontWeight: 300, letterSpacing: "0.12em", textTransform: "uppercase", color: "#555", cursor: "pointer", marginBottom: 40, transition: "color 0.3s, letter-spacing 0.35s ease", display: "inline-block" }}
