...
const PROJECTS = {
  all: [
    { id: 1, title: "Figs x New Balance 997H — Extremes", role: "Director", category: "Brand", aspect: "16/9", thumb: "/images/thumb_8.jpg", vimeo: "909886821", stills: ["/images/stills/figs_nb_02.jpg", "/images/stills/figs_nb_03.jpg", "/images/stills/figs_nb_01.jpg", "/images/stills/figs_nb_04.jpg", "/images/stills/figs_nb_05.jpg"] },
    ...
    { id: 16, title: "Orlando Pride — The Decennial Kit", role: "Director", category: "Brand", aspect: "16/9", thumb: "/images/thumb_2.jpg", vimeo: "1061834025", stills: ["/images/stills/orlando_pride_01.jpg", "/images/stills/orlando_pride_02.jpg", "/images/stills/orlando_pride_03.jpg", "/images/stills/orlando_pride_04.jpg", "/images/stills/orlando_pride_05.jpg"] },
    ...
    { id: 11, title: "Giveon — Lost Me", role: "Editor", category: "Music", aspect: "16/9", thumb: "/images/edit_6.jpg", youtube: "bi28CVlg4TA" },
  ...
  return (
    <div ref={ref} onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} onClick={() => onClick(project)}
      ...
      <div style={{ marginTop: 14 }}>
        <div className="hover-spread" style={{ fontSize: 11, fontWeight: 300, letterSpacing: "0.08em", color: hovered ? "#e8e4df" : "#999", transition: "color 0.3s ease, letter-spacing 0.35s ease", textTransform: "uppercase" }}>{project.title}</div>
  ...
  return (
    <div>
        ...
        <div className="project-detail-padded vignette-tabs" style={{ maxWidth: 720, margin: "0 auto", display: "flex", gap: 20, marginBottom: 32 }}>
          {project.vignettes.map((v, i) => (
            <div key={i} onClick={() => setActiveVignette(i)}
              ...
              style={{ fontSize: 10, fontWeight: activeVignette === i ? 400 : 300, letterSpacing: "0.1em", textTransform: "uppercase", color: activeVignette === i ? "#e8e4df" : "#555", cursor: "pointer", transition: "color 0.3s, letter-spacing 0.35s ease", paddingBottom: 3, borderBottom: activeVignette === i ? "1px solid #e8e4df" : "1px solid transparent" }}
      ...
      <div style={{ maxWidth: 720, margin: "60px auto 40px", textAlign: "center" }}>
        <div onClick={onBack} className="hover-spread"
          style={{ fontSize: 11, fontWeight: 300, letterSpacing: "0.12em", textTransform: "uppercase", color: "#555", cursor: "pointer", transition: "color 0.3s, letter-spacing 0.35s ease", display: "inline-block" }}
...
function HomeBlurb({ animate, onAnimated, onNavigate }) {
  ...
  const [splashThumbs] = useState(() => {
    ...
    return [...directors, ...editors].map(p => p.thumb);
  });
  useEffect(() => {
    ...
    <div className="home-blurb-parent" style={{ position: "relative", minHeight: "100vh", overflow: "hidden" }}>
      ...
      {(splashPhase === "thumbnails" || splashPhase === "pause") && (
        <div style={{ position: "absolute", inset: 0, zIndex: 1, background: "#000", display: "flex", alignItems: "center", justifyContent: "center" }}>
          {splashPhase === "thumbnails" && currentThumb < splashThumbs.length && (
            <img key={currentThumb} src={splashThumbs[currentThumb]} alt="" className="splash-thumb" style={{
    ...
    <div ref={scrollRef} style={{ background: "#000", height: "100vh", color: "#e8e4df", fontFamily: "'Outfit', 'Helvetica Neue', Helvetica, sans-serif", position: "relative", overflowX: "hidden", overflowY: "auto" }}>
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .hover-spread { transition: letter-spacing 0.35s ease, color 0.3s ease; }
        .hover-spread:hover { letter-spacing: 0.18em !important; }
      `}</style>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          {navItems.map((item) => (
            <div key={item.key} onClick={() => { doTransition(() => { setPage(item.key); setWorkFilter("All"); setSelectedProject(null); }); }} onMouseEnter={() => setNavHover(item.key)} onMouseLeave={() => setNavHover(null)}
              className="hover-spread"
              style={{ fontSize: 12, fontWeight: page === item.key ? 400 : 300, letterSpacing: "0.06em", color: page === item.key ? "#e8e4df" : navHover === item.key ? "#888" : "#444", cursor: "pointer", transition: "color 0.3s ease, letter-spacing 0.35s ease" }}>
              {item.label}
            </div>
          ))}
        </div>
            ...
            <div className="work-header" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 52 }}>
              <div className="filter-row" style={{ display: "flex", alignItems: "center", gap: 24 }}>
                {["All", "Director", "Editor"].map((f) => (
                  <div key={f} onClick={() => setWorkFilter(f)} className="hover-spread" style={{ fontSize: 10, fontWeight: 400, letterSpacing: "0.12em", textTransform: "uppercase", color: workFilter === f ? "#e8e4df" : "#444", cursor: "pointer", transition: "color 0.3s, letter-spacing 0.35s ease", paddingBottom: 3 }}>{f}</div>
                ))}
              </div>
              <div className="social-row" style={{ display: "flex", gap: 20 }}>
                <a href="https://www.instagram.com/blaizefobbe/" target="_blank" rel="noopener noreferrer" className="hover-spread" style={{ fontSize: 9, fontWeight: 400, letterSpacing: "0.16em", textTransform: "uppercase", color: "#444", transition: "color 0.3s, letter-spacing 0.35s ease" }} onMouseEnter={(e) => e.target.style.color = "#e8e4df"} onMouseLeave={(e) => e.target.style.color = "#444"}>Instagram</a>
                <a href="https://vimeo.com/blaizefobbe" target="_blank" rel="noopener noreferrer" className="hover-spread" style={{ fontSize: 9, fontWeight: 400, letterSpacing: "0.16em", textTransform: "uppercase", color: "#444", transition: "color 0.3s, letter-spacing 0.35s ease" }} onMouseEnter={(e) => e.target.style.color = "#e8e4df"} onMouseLeave={(e) => e.target.style.color = "#444"}>Vimeo</a>
              </div>
            </div>
